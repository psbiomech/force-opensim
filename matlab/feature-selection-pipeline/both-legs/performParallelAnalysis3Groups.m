function [pcsexplained, totalvalidpcs, totalvariance, paselected, paquantl] = performParallelAnalysis3Groups(pcadata, pcaweights, pcaout, pcainfo)

%PERFORMPARALLELANALYSIS3GROUPS Undertake Parallel Analysis for FORCe SDP
