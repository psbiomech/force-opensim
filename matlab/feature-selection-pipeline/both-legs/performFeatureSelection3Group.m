function [final, weissind, training] = performFeatureSelection3Groups(paselected, pcainfo)



%PERFORMFEATURESELECTION3GROUPS Perform Feature Selection for FORCe SDP
