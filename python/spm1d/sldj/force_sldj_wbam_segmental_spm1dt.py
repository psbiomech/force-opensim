...
outfilename = "force_sldj_spm1dt_wbam_segmental_normalised_more_ctrl"
...
# Data labels
varprefix = ["L_seg_talus", "L_seg_calcn", "L_seg_toes", "L_seg_tibia", "L_seg_patella", "L_seg_femur", "L_seg_humerus", "L_seg_radius", "L_seg_ulna", "L_seg_hand"]
genericvars = ["L_seg_pelvis", "L_seg_torso"] + varprefix
limb = ["stance", "swing"]
subjtype = ["sym", "ctrl"]
