# -*- coding: utf-8 -*-
'''
FORCE SINGLE LEG DROP JUMP: CENTRE OF MASS KINEMATICS (RELATIVE TO COP)
...
outfilename = "force_sldj_spm1dt_com_normalised_more_ctrl"
...
# Data labels
variables = ["com_r_cop_X", "com_r_cop_Y", "com_r_cop_Z"]
subjtype = ["sym", "ctrl"]
...
# Plot parameters
plotheads = ["Fore-aft (X)", "Vertical (Y)", "Mediolateral (Z)"]
...
fig.suptitle("Single-leg drop-jump: %s vs %s. CoM trajectories." % (subjtypefulllabel[0].upper(), subjtypefulllabel[1].upper()), fontsize=20)
